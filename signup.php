...
<head>
    ...
    <title>Baraka Qurulish Do'koni - Ro'yxatdan o'tish</title>
...
<body class="bg-gray-100">
    ...
    <section class="pt-24 pb-12 bg-gradient-to-b from-blue-100 to-white">
        <div class="container mx-auto px-4">
            <h1 class="text-3xl md:text-4xl font-bold text-center text-blue-900 mb-8 animate-fade-in">Ro'yxatdan o'tish</h1>
            <div class="max-w-lg mx-auto bg-white p-8 rounded-xl shadow-lg">
                <form method="post" action="user_registration_script.php">
                    <div class="mb-4">
                        <label for="name" class="block text-blue-900 font-semibold mb-2">Ism:</label>
                        <div class="relative">
                            <i class="fas fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                            <input type="text" id="name" name="name" placeholder="Ismingizni kiriting" required class="w-full pl-10 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400">
                        </div>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <label for="contact" class="block text-blue-900 font-semibold mb-2">Telefon:</label>
                        <div class="relative">
                            <i class="fas fa-phone absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                            <input type="tel" id="contact" name="contact" placeholder="Telefon raqamingiz" required class="w-full pl-10 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400">
                        </div>
                    </div>
                    <div class="mb-4">
                        <label for="city" class="block text-blue-900 font-semibold mb-2">Shahar:</label>
                        <div class="relative">
                            <i class="fas fa-city absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                            <input type="text" id="city" name="city" placeholder="Shaharni kiriting" required class="w-full pl-10 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400">
                        </div>
                    </div>
                    <div class="mb-4">
                        <label for="address" class="block text-blue-900 font-semibold mb-2">Manzil:</label>
                        <div class="relative">
                            <i class="fas fa-map-marker-alt absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
                            <input type="text" id="address" name="address" placeholder="Manzilingizni kiriting" required class="w-full pl-10 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400">
                        </div>
                    </div>
                    <button type="submit" class="w-full bg-yellow-400 text-blue-900 font-semibold py-3 rounded-lg hover:bg-yellow-500 transition-all duration-300">Ro'yxatdan o'tish</button>
                </form>
            </div>
        </div>
    </section>
